...
function pollingS3DomainUsage(domain_path, callback) {
    var domain_id = domain_path.split('/')[2];
    console.log("**********domain_id")
    console.log(domain_id);
  ...
  //       // FetchOwner: true,
  //       MaxKeys: 100,
  //       Prefix: 'zMdCD2J7xrdn77gzcgpiJyQ/886386c171b7b53b5b9a8fed7f720daa96297225fdecd2e81b889a6be7abbf9d/5743356b-e71f-48cd-b915-019171a7a6a6',
