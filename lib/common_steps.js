...
var queryObject = function (app_id, domain_id, object_id, callback) {
  console.log(app_id);
  ...
  var params = {
    ...
    IndexName: 'domain_id-id-index',
    KeyConditionExpression: 'domain_id = :hkey and id = :rkey',
    ExpressionAttributeValues: {
      ':hkey': domain_id,
      ':rkey': object_id
    }
    ...
    return new Promise((resolve, reject) => {
      ...
      if (object.Count == 1) {
        ...
        var payload = {
          ...
          ConditionExpression: '#id = :object_id',
          ExpressionAttributeNames:{
              "#usage": "usage",
              "#id": "id",
...
var getS3ObjectUsage = function(promises) {
  ...
  return new Promise((resolve, reject) => {
      ...
      var params = {
        ...
        // FetchOwner: true,
        MaxKeys: 2,
        // Prefix: 'zMdCD2J7xrdn77gzcgpiJyQ/886386c171b7b53b5b9a8fed7f720daa96297225fdecd2e81b889a6be7abbf9d/5743356b-e71f-48cd-b915-019171a7a6a6/6396f119-98a4-459a-b86a-df258a44c918',
...
CommonSteps.getS3ObjectUsage = getS3ObjectUsage;
