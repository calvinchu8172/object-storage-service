...
apiErrors.forbidden.x_api_key                        = { httpStatus: 403, message: `Forbidden` } // 這是給自動化測試判斷用的， X-API-Key 沒帶，是 API-GateWay 直接回傳 403
...
apiErrors.notFound.sqs                               = { message: `SQS is empty` }
