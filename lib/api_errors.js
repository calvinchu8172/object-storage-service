...
apiErrors.missingRequiredParams.access_token       = { httpStatus: 400, code: "400.6", message: "Missing Required Parameter: access_key" }
...
apiErrors.validationFailed.access_token              = { httpStatus: 400, code: "401", message: "Invalid access_token" }
apiErrors.validationFailed.over_domain_limit         = { httpStatus: 400, code: "400.12", message: `Exceeded The Limit Of ${DOMAINS_LIMIT} Domains` }
apiErrors.validationFailed.domain_already_exists     = { httpStatus: 400, code: "400.11", message: `Domain Already Exists` }
